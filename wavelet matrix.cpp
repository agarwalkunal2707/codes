...
// int rank(const int val, const int l, const int r): Counts the number of occurrences of a value val in a specified range [l, r) of the array.
// int quantile(int k, int l, int r): Finds the k-th smallest element in the range [l, r)
// long long topKsum(int k, int l, int r): Calculates the sum of the top k largest elements in the specified range [l, r).
// int rangefreq(const int l, const int r, const int a, const int b) Counts how many numbers in the range [l, r) fall within a range [a, b).
// int rangemin(int l, int r, int a, int b): Finds the smallest number in the range [l, r) that also lies within the range [a, b).
